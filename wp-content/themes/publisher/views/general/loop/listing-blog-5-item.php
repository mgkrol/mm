...
?>
	<<?php echo $section_tag; ?><?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-item-blog  listing-item-blog-5 ' . $class ); ?>>
	<div class="item-inner clearfix">
		...
		if ( publisher_get_prop( 'show-excerpt', TRUE ) ) { ?>
			<div class="post-summary">
				...
				publisher_the_excerpt( publisher_get_prop( 'excerpt-limit', 240 ), NULL, TRUE, FALSE );
		...
		} elseif ( publisher_get_prop( 'show-read-more', TRUE ) ) {

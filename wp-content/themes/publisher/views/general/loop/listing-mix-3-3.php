...
if ( ! publisher_get_prop( 'block-customized', FALSE ) ) {
	$block_settings = publisher_get_option( 'listing-mix-3-3' );
...
?>
	<div class="listing listing-mix-3-3 clearfix <?php publisher_echo_prop( 'listing-class' ); ?>">

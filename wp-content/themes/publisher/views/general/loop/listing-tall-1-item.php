...
$thumbnail_size  = publisher_get_prop_thumbnail_size( 'publisher-tall-big' );
...
?>
	<<?php echo $section_tag; ?><?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-item-tall listing-item-tall-1 ' . $main_term_class ); ?>>

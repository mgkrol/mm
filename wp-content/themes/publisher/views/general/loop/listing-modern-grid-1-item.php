<?php
/**
 * Template of each item in modern listing 1
 *
 * @author     BetterStudio
 * @package    Publisher
 * @version    1.9.0
...
?>
	<<?php echo $section_tag; ?><?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-mg-item listing-mg-type-1 listing-mg-1-item ' . $main_term_class ) ?>>

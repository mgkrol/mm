...
if ( ! publisher_get_prop( 'block-customized', FALSE ) ) {
	...
	$block_settings = publisher_get_option( 'listing-user-5' );
...
?>
	<div class="listing listing-user type-2 style-2 <?php publisher_echo_prop( 'listing-class' ); ?> clearfix">
		<?php
		...
		foreach ( $query->get_results() as $user ) {
			...
			publisher_get_view( 'loop', 'listing-user-5-item' );
			$printed ++;
		}

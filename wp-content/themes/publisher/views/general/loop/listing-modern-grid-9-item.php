<?php
/**
 * Template of each item in modern listing 9
 *
 * @author     BetterStudio
 * @package    Publisher
 * @version    1.9.0
...
?>
	<<?php echo $section_tag; ?><?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-mg-item listing-mg-9-item listing-mg-type-1 ' . $main_term_class ) ?>>
	<div class="item-content">
		...
		if ( publisher_get_prop( 'show-term-badge', TRUE ) ) {
			publisher_cats_badge_code( publisher_get_prop( 'term-badge-count', TRUE ), '', FALSE, TRUE, 'floated' );
		}

<?php
/**
 * Template of each item in modern listing 7
 *
 * @author     BetterStudio
 * @package    Publisher
 * @version    1.9.0
...
?>
	<<?php echo $section_tag; ?><?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-mg-item listing-mg-7-item listing-mg-type-1 ' . $main_term_class ) ?>>

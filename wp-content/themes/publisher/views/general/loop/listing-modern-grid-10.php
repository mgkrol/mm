...
if ( ! publisher_get_prop( 'block-customized', FALSE ) && publisher_have_posts() ) {
	...
	$block_settings = publisher_get_option( 'listing-modern-grid-10' );
...
?>
	<div class="listing listing-modern-grid listing-modern-grid-10 clearfix <?php publisher_echo_prop( 'listing-class' ); ?>">
		<div class="mg-row mg-row-1 clearfix">
			<div class="mg-col mg-col-1">
				...
				if ( publisher_have_posts() ) {
					...
					publisher_get_view( 'loop', 'listing-modern-grid-10-item' );

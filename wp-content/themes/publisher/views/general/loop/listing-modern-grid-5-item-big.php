...
?>
	<<?php echo $section_tag; ?><?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-mg-item listing-mg-5-item listing-mg-5-item-big ' . $main_term_class ) ?>>
	...
	<div class="content-container">
		...
		<a href="<?php publisher_the_permalink(); ?>" class="post-url post-title">
			<?php publisher_echo_html_limit_words( publisher_get_the_title(), publisher_get_prop( 'title-limit', 120 ) ); ?>
		</a>

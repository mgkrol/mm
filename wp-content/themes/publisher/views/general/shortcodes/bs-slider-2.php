...
?>
	<div class="bs-shortcode bs-slider bs-slider-2 clearfix <?php publisher_echo_prop( 'listing-class' ); ?>">
		...
		<div class="better-slider" id="<?php echo esc_attr( $slider_id ); ?>"
			...
			<ul class="slides">
				...
				while( publisher_have_posts() ) {
					...
					?>
					<li class="slide bs-slider-item bs-slider-2-item <?php echo $class; ?>">

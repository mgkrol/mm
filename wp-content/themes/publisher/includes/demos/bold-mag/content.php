	...
	return array(
		...
		'posts'    =>
			array(
				...
				array(
					...
					array(
						'post_title'        => 'The Whitby is a Contemporary-Style Hotel You’ll Want to Visit in New York',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
					...
					array(
						'post_title'        => 'For World Music Therapy Day, We Look at the Life-Changing Power of a Good Song',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
					...
					array(
						'post_title'        => 'Water is the Key Ingredient to Smoother Skin, Healthier Bodies and Happier Lives',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
					...
					array(
						'post_title'        => 'One Writer Tries to Eat her Way Through Hong Kong’s 14,000 Restaurants',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-6%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'The Canadian Woman Helping Girls In Sub-Saharan Africa Stay In School',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-8%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Lagerfeld Sketches Weinstein as Pig, Edie Campbell Writes Open Letter on Model Abuse',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-3%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Gigi Hadid’s Second Collab With Stuart Weitzman Stars in Tory Burch Holiday Vid',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-5%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Legendary Couturier and Audrey Hepburn Collaborator Hubert de Givenchy Dies at 91',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-6%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Nordstrom’s K-Fashion Pop-Up Shop Brings the Best of SoKo Style to Canada',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-8%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'This Feminism-Themed Shoot From Our March Issue Only Features Female-Designed Clothes',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-7%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Givenchy Unveils Its Debut Children’s Collection and It Has Cool Kid Written All Over It',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-1%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Airbnb is Giving Away an Out-Of-This-World Trip to Two Lucky Space Fans',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-9%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '5 Things Will and Kate Didn’t Do in Poland, But You Definitely Should',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-10%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'The June is the Instagrammable Motel You’ll Want to Head to This Summer',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-11%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'FASHION Magazine Summer 2018 cover: Heather Marks in Mexico City',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-12%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Laucala is One of the Most Exclusive (and Instagram-worthy) Destinations',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-7%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Celeb Trainer Taryn Toomey Teaches The Class in Vancouver to Launch Lululemon Collab',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-1%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Offset & Metro Boomin Call Out Epic Records For Bad Business Practices',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-9%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Instagram’s New Campaign Encourages Users to Talk Openly About Mental Health',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-8%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Just in Time for London Fashion Week, Here Are The City’s Most Fashionable Haunts',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-10%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Sabrina Firman Tells us How to Get the Most Out of Milan Fashion Week',
						'post_format'       => 'video',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-11%%',
						...
						'post_meta'         => array(
							...
							array(
								...
								'meta_value' => 'www.theguardian.com',
							),
							array(
								'meta_key'   => '_bs_source_url',
								'meta_value' => 'https://www.theguardian.com',
							),
						),
					...
					array(
						'post_title'        => 'After This Past Year’s Activism, Are Spring’s Feminine Designs Demeaning or Empowering?',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-2%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Why Eloping in Antigua Was the Most Powerful Thing This Writer Ever Did',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-1%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '“Drake & Future” Reportedly Dropped From $25 Million Rape Lawsuit',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-3%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'The Wholesome Trend Even the Kardashians Are Getting Behind',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-4%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Tessa Virtue Talks Social Media, Self-Care and Yes, Scott Moir',
						'post_format'       => 'video',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-1%%',
					...
					array(
						'post_title'        => 'How a Solo-Trip to New Zealand Changed One Writer’s View of Her Future',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-12%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'The Radical Makeup Artist Behind Tom Ford’s Extrême Makeup Collection',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-2%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Peace Out, Thanksgiving Food Baby! 5 Ways to Get Rid of Belly Bloat',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-9%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'In a World Embracing “Ageless Fashion,” Is 80 the New 20?',
						'post_format'       => 'video',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-3%%',
					...
					array(
						'post_title'        => 'Why Are People So Angry About the New Holi-Inspired Pharrell x Adidas Collab?',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-4%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Olympic Medallist Phylicia George on Walking in Her First Ever Runway Show',
						'post_format'       => 'video',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-5%%',
					...
					array(
						'post_type'  => 'better-banner',
						'post_title' => 'Index Sidebar Inline',
						'post_meta'  => array(
							array(
								'meta_key'   => 'type',
								'meta_value' => 'image',
		...
		'media'    =>
			array(
				...
				array(
					'file'   => $demo_image_url . $prefix . 'ad-big.jpg',

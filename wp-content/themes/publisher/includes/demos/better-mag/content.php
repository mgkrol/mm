		...
		'posts'    =>
			array(
				...
				array(
					...
					array(
						'post_title'        => 'How to navigate the weird and wonderful world of Chinese cuisine',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
					...
					array(
						'post_title'        => 'Travel can help you discover what you want in life, here’s why',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-8%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'How to Wear 2017\'s Biggest Trend - Pop Colours',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-11%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Give Your House And Closet A Pantone Summer Recipes',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-10%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Our 10 Most Popular Easter Recipes',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-2%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Happy Birthday, America! Our Most Popular Recipes Right Now',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-3%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '11 of Melissa Clark\'s Favorite Cakes',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-12%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Sitting in jet engine chair turns anyone into a super villain product',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-11%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '32 Bright and Beautiful Summer Pastas',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-9%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Your Courtside Style Just Got Better Thanks to Levi’s',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-5%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Behind the Scenes at the Victoria’s Secret Shanghai Show',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-4%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'We Talk to Four CAMH Difference Makers Working to End the Stigma',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-3%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '2018 American Music Awards Best Red Carpet Looks',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-2%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Kendall Jenner Dethrones Gisele Bündchen as World’s Highest Paid Model',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-6%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'New Glasses Collaboration Spotlights Four Toronto Artists',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-7%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Travel apps every digital nomad needs to have to stay on the road',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-1%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Meghan Markle’s Engagement Outfit Was a Major Shoutout to Canada',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-9%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'How to Wear Glitter Makeup If You Hate the Unicorn Trend',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-1%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'The benefits of using time tracking tools for small businesses',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-6%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '14 surreal places in America even the locals may not have explored',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-5%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '5 interesting treks in Nepal and what you should know about them',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-4%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Top 10 most common regrets people have when they look back on their lives',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-8%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Seven reasons to visit Pistoia, a ‘little Florence’',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-11%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '5 Hair Brands That Cater to Women of Colour With Great Products',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-10%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Peggy Sue Collection Wins 2017 Emerging Designer Competition',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-11%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'The Swarovski Holiday Collection’s Diverse Campaign Launches in Style',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-12%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Honey Afternoon Tea reviewed, St Ermin’s Hotel Westminster, London',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-11%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Here’s the Exclusive Promo Code You Need to Save Big at The Outnet',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-6%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Everything We Know About Prince Harry and Meghan Markle’s Engagement',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-10%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'Fash Points: Meghan Markle in Mackage, Uniqlo x JW Anderson is Coming Back',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-3%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'New York’s antiquated steering wheel law poses roadblock to driverless',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-2%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '15 Party Dresses Under $200 To Get You Into the Holiday Spirit',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-1%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => 'How To Style A Choker So You Don’t Look Like Every Other Girl',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-12%%',
						'post_terms'        => array(
					...
					array(
						'post_title'        => '12 reasons you should visit San Francisco once in your lifetime',
						'post_content_file' => $demo_path . 'post-content-2.txt',
						'post_excerpt_file' => $demo_path . 'post-excerpt.txt',
						'thumbnail_id'      => '%%media.primary.thumb-2%%',
						'post_terms'        => array(
					...
					array(
						...
						'post_meta'  => array(
							...
							array(
								'meta_key'   => 'text_desc',
								'meta_value' => 'Publisher is the useful and powerful WordPress Newspaper , Magazine and Blog theme with great attention to details, incredible features, an intuitive user interface and everything else you need to create outstanding websites.',
							),
							array(
				...
				array(
					...
					array(
						...
						'option_value'  => array(
							...
							'header_aside_logo_banner' => '%%posts.primary.192%%',
						),
						'merge_options' => TRUE,
					),
				),

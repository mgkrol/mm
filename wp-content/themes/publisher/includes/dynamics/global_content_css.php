...
<?php echo esc_attr( $content_parent ); ?> h1{
	font-size: <?php publisher_echo_option( 'typo_heading_h1' ); ?>;
}
<?php echo esc_attr( $content_parent ); ?> h2{
	font-size: <?php publisher_echo_option( 'typo_heading_h2' ); ?>;
}
<?php echo esc_attr( $content_parent ); ?> h3{
	font-size: <?php publisher_echo_option( 'typo_heading_h3' ); ?>;
}
<?php echo esc_attr( $content_parent ); ?> h4{
	font-size: <?php publisher_echo_option( 'typo_heading_h4' ); ?>;
}
<?php echo esc_attr( $content_parent ); ?> h5{
	font-size: <?php publisher_echo_option( 'typo_heading_h5' ); ?>;
}
<?php echo esc_attr( $content_parent ); ?> h6{
	font-size: <?php publisher_echo_option( 'typo_heading_h6' ); ?>;
}
...
p:last-child,
<?php echo esc_attr( $content_parent ); ?> p:last-child {
	margin-bottom: 0;
}
